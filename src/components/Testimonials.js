              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  <div className="text-center sm:text-left">
                    ...
                    <p
                      className={`text-sm uppercase tracking-wider ${currentTestimonial.color}`}
                    >
            ...
            {testimonials.map((testimonial, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`cursor-pointer p-4 rounded-xl flex items-center transition-all ${
                ...
                >
                  ...
                  <div className="flex-grow">
                    ...
                    <p
                      className={`text-xs uppercase tracking-wider ${testimonial.color}`}
                    >
                      {testimonial.role}
                    </p>
                  </div>
